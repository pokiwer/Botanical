...
@section('content')
        ...
        <div class="slick-fade">
            <div>
                ...
                <div class="align w-100 d-flex align-items-center bgCover"
                    style="background-image: url({{ asset('images/b-bg4.jpg') }})">
                    <div class="container position-relative holder pt-xl-10">
                        <div class="row">
                            <div class="col-12 col-xl-7">
                                <div class="txtwrap pr-xl-10">
                                    <span
                                        class="title d-block text-uppercase fwEbold position-relative pl-2 mb-md-5 mb-sm-3">wellcome
                                        to botanical</span>
                                    <h1 class="fwEbold position-relative mb-md-7 mb-sm-4">Houseplant <span
                                            class="text-break d-block">The Perfect Choice.</span></h1>
                                    <p class="mb-md-15 mb-sm-10">Lorem ipsum is simply dummy text of the printing and
                                        typesetting industry.</p>
                                    <a href="shop.html"
                                        class="btn btnTheme btnShop fwEbold text-white md-round py-3 px-4">Shop Now <i
            ...
            <div>
                <!-- align -->
                <div class="align w-100 bgCover" style="background-image: url({{ asset('images/b-bg5.jpg') }});">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <blockquote class="quotationBlock text-center d-block m-0">
                    <q class="d-block playfair mb-7">We ship healthy potted plants right to your doorstep. Each plant comes
                        with simple care instructions from our plant experts.</q>
                    <cite class="d-block">
    ...
    <section class="featureSec container overflow-hidden pt-xl-12 pb-xl-9 pt-lg-10 pb-lg-4 pt-md-8 pb-md-2 pt-5">
        ...
        <div class="row">
            @foreach ($trees->take(4) as $tree)
                <div class="col-12 col-sm-6 col-lg-3 featureCol position-relative mb-6">
                    <div class="border">
                        <div class="imgHolder position-relative w-100 overflow-hidden">
                            <img src="{{ asset('images/' . $tree->image) }}" alt="image description"
                                class="img-fluid w-100">
                            <ul class="list-unstyled postHoverLinskList d-flex justify-content-center m-0">
                                <li class="mr-2 overflow-hidden"><a href="" class="icon-heart d-block"></a>
                                </li>
                                <li class="mr-2 overflow-hidden"><a href="" class="icon-cart d-block"></a>
                                </li>
                                <li class="mr-2 overflow-hidden"><a href="" class="icon-eye d-block"></a>
                                </li>
                                <li class="overflow-hidden"><a href="" class="icon-arrow d-block"></a></li>
                            </ul>
                        </div>
                        <div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
                            <span class="title d-block mb-2"><a href="">{{ $tree->name }}</a></span>

                            @if ($tree->deal[0]->sale !== 0 && $tree->deal[0]->toprate === 1)
                                <span
                                    class="hotOffer fwEbold text-uppercase text-white position-absolute d-block">Hot</span>
                                <span class="price d-block fwEbold"><del>{{ $tree->price }}
                                        Đ</del>{{ $tree->price - ($tree->price * $tree->deal[0]->sale) / 100 }}
                                    Đ</span>
                                <span <span
                                    class="hotOffer green fwEbold text-uppercase text-white position-absolute d-block">Sale</span>
                            @elseif ($tree->deal[0]->sale !== 0)
                                <span class="price d-block fwEbold"><del>{{ $tree->price }}
                                        Đ</del>{{ $tree->price - ($tree->price * $tree->deal[0]->sale) / 100 }}
                                    Đ</span>
                                <span
                                    class="hotOffer fwEbold text-uppercase text-white position-absolute d-block">Hot</span>
                            @elseif ($tree->deal[0]->toprate === 1)
                                <span class="price d-block fwEbold">{{ $tree->price }} Đ</span>
                                <span
                                    class="hotOffer green fwEbold text-uppercase text-white position-absolute d-block">Sale</span>
                            @else
                                <span class="price d-block fwEbold">{{ $tree->price }} Đ</span>
                ...
                <div class="border">
                    <div class="imgHolder position-relative w-100 overflow-hidden">
                        ...
                        <ul class="list-unstyled postHoverLinskList d-flex justify-content-center m-0">
                            ...
                            <li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-cart d-block"></a>
                            </li>
                            <li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-eye d-block"></a>
                            </li>
                ...
                <div class="itemCol">
                    <div class="position-relative">
                        ...
                        <div class="hoverTextBlock position-absolute">
                            <h2 class="headingIV playfair fwEbold mb-3"><a href="javascript:void(0);">Cactus Plant</a>
                            </h2>
            ...
            <div class="grid-item mb-6 px-3">
                <div class="itemCol">
                    <div class="position-relative">
                        ...
                        <div class="hoverTextBlock position-absolute">
                            <h2 class="headingIV playfair fwEbold mb-3"><a href="javascript:void(0);">Indoor Plant</a>
                            </h2>
            ...
            <div class="grid-item grid-item2 mb-6 px-3">
                <div class="itemCol">
                    <div class="position-relative">
                        ...
                        <div class="hoverTextBlock position-absolute">
                            <h2 class="headingIV playfair fwEbold mb-3"><a href="javascript:void(0);">Tropical Plant</a>
                            </h2>
                            ...
                            <div class="border">
                                <div class="imgHolder position-relative w-100 overflow-hidden">
                                    ...
                                    <ul class="list-unstyled postHoverLinskList d-flex justify-content-center m-0">
                                        ...
                                        <li class="mr-2 overflow-hidden"><a href="javascript:void(0);"
                                                class="icon-eye d-block"></a>
                                        </li>
                                        <li class="overflow-hidden"><a href="javascript:void(0);"
                                                class="icon-arrow d-block"></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="text-center py-5 px-4">
                                    <span class="title d-block mb-2"><a
                                            href="shop-detail.html">{{ $tree->name }}</a></span>
                                    @if ($tree->deal[0]->sale !== 0 && $tree->deal[0]->toprate == 1)
                                        <span class="price d-block fwEbold"><del>{{ $tree->price }}
                                                Đ</del>{{ $tree->price - ($tree->price * $tree->deal[0]->sale) / 100 }}
                                            Đ</span>
                                    ...
                                    @elseif($tree->deal[0]->sale !== 0 && $tree->deal[0]->toprate == 0)
                                        <span class="price d-block fwEbold"><del>{{ $tree->price }}
                                                Đ</del>{{ $tree->price - ($tree->price * $tree->deal[0]->sale) / 100 }}
                                            Đ</span>
                                        <span
                                            class="hotOffer green fwEbold text-uppercase text-white position-absolute d-block">Sale</span>
                                    @elseif($tree->deal[0]->sale === 0 && $tree->deal[0]->toprate == 1)
                                        <span class="price d-block fwEbold">{{ $tree->price }} Đ</span>
                                        <span
                                            class="hotOffer fwEbold text-uppercase text-white position-absolute d-block">HOT</span>
                                    @endif
    ...
    <div class="container-fluid px-xl-20 px-lg-10">
        <!-- testimonailBlock -->
        <section class="testimonailBlock bgCover py-xl-24 py-lg-20 py-md-16 py-10"
            style="background-image: url(http://placehold.it/1720x560)">
                ...
                <div class="testimonailSlider overflow-hidden">
                    <div>
                        <div class="slide text-center mb-7">
                            ...
                            <p class="mb-7">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                                exercitation ullamco laboris nisi ut aliquip ex ea com- modo consequat. </p>
                    ...
                    <div>
                        <div class="slide text-center mb-7">
                            ...
                            <p class="mb-7">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                ...
                                exercitation ullamco laboris nisi ut aliquip ex ea com- modo consequat. </p>
                            <strong class="title d-block fwEbold mb-1">Sarah Jefferson</strong>
                            <span class="desination">Dặng Bảo Long</span>
                        </div>
                    </div>
                    <div>
                        <div class="slide text-center mb-7">
                            ...
                            <p class="mb-7">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                ...
                                exercitation ullamco laboris nisi ut aliquip ex ea com- modo consequat. </p>
                            <strong class="title d-block fwEbold mb-1">Sarah Jefferson</strong>
                            <span class="desination">Hồ Quang Hiếu</span>
                        </div>
                    </div>
                    <div>
                        <div class="slide text-center mb-7">
                            ...
                            <p class="mb-7">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                ...
                                exercitation ullamco laboris nisi ut aliquip ex ea com- modo consequat. </p>
                            <strong class="title d-block fwEbold mb-1">Sarah Jefferson</strong>
                            <span class="desination">Chu Văn Lợi</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="newsPostColumn text-center px-2 pb-6 mb-6">
                    <div class="imgHolder position-relative mb-6">
                        <a href="blog-detail.html">
                            ...
                            <time class="time text-uppercase position-absolute py-2 px-1" datetime="2019-02-03 20:00">
                                <strong class="fwEbold d-block">20</strong> Sep</time>
                        </a>
                    </div>
                    <span class="postBy d-block mb-3">Post by: <a href="blog-detail.html">Jane doe</a></span>
                    <h2 class="headingV fwEbold mb-2"><a href="blog-detail.html">Aptent taciti soci litora cianpen</a>
                    </h2>
                ...
                <div class="newsPostColumn text-center px-2 pb-6 mb-6">
                    <div class="imgHolder position-relative mb-6">
                        <a href="blog-detail.html">
                            <img src="http://placehold.it/370x250" alt="image description" class="img-fluid w-100">
                            <time class="time text-uppercase position-absolute py-2 px-1" datetime="2019-02-03 20:00">
                                <strong class="fwEbold d-block">18</strong> Sep</time>
                        </a>
                    </div>
                    <span class="postBy d-block mb-3">Post by: <a href="blog-detail.html">Jane doe</a></span>
                    <h2 class="headingV fwEbold mb-2"><a href="blog-detail.html">Aptent taciti soci litora cianpen</a>
                ...
                <div class="newsPostColumn text-center px-2 pb-6 mb-6">
                    <div class="imgHolder position-relative mb-6">
                        <a href="blog-detail.html">
                            <img src="http://placehold.it/370x250" alt="image description" class="img-fluid w-100">
                            <time class="time text-uppercase position-absolute py-2 px-1" datetime="2019-02-03 20:00">
                                <strong class="fwEbold d-block">21</strong> Sep</time>
                        </a>
                    </div>
                    <span class="postBy d-block mb-3">Post by: <a href="blog-detail.html">Jane doe</a></span>
                    <h2 class="headingV fwEbold mb-2"><a href="blog-detail.html">Aptent taciti soci litora cianpen</a>
